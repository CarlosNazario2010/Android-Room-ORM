...
/*
    OBS: Projeto realizado na versao 30 da API do Android, visto a partir
    da API 30 do Android (Android 11), a AsyncTask ficou obsoleta (deprecated).
    Como alternativa, a documentação sugere o uso das APIs do Java do pacote
    java.util.concurrent ou as Coroutines do Kotlin.
 */
...
public class ListaAlunosActivity extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu,
        ...
        getMenuInflater().inflate(
                R.menu.activity_lista_alunos_menu, menu);
    }
    ...
    private void configuraLista() {
        ListView listaDeAlunos = findViewById(
                R.id.activity_lista_alunos_listview);
